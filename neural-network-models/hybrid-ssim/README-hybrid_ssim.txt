...
- Tuning: The results of the hyperparameter tuning process of the hybrid network using SSIM are available here

The following files are also present:

- input2image_ssim.py: Main python file that sets up and runs the neural network
...
- weights of SSIM-alone training

- weights of pre-training neural network with MSE

- weights of training with SSIM on pre-trained network
